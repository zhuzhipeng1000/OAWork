...
- (void)viewDidLoad
{
    ...
    [lb setTitle:@"取消" forState:UIControlStateNormal];
    ...
    [lb addTarget:self.parent action:@selector(cancelImagePicker) forControlEvents:UIControlEventTouchUpInside];
        ...
        // Group enumerator Block
            ...
            void (^assetGroupEnumberatorFailure)(NSError *) = ^(NSError *error) {
                ...
                if ([ALAssetsLibrary authorizationStatus] == ALAuthorizationStatusDenied) {
                    NSString *errorMessage = @"没有权限打开系统相册，请在设置中打开.";
                    [[[UIAlertView alloc] initWithTitle:@"权限限制" message:errorMessage delegate:nil cancelButtonTitle:@"确定" otherButtonTitles:nil] show];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [picker setReferenceURLInfo:self.referenceURLInfo];
